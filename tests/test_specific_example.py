...
class TestSpecificHy8Runner:
    ...
    def set_crossing_data(self, hy8_runner):
        ...
        hy8_runner.set_discharge_min_design_max_flow(0, 600, 1000)
        # Set the tailwater channel
        bottom_width = 100.0
        channel_slope = 0.001
        manning_n = 0.04
        ...
        hy8_runner.set_culvert_barrel_span_and_rise(6, 5)
        # Set the culvert barrel site data
        hy8_runner.set_culvert_barrel_site_data(0, 11.35, 293, 11.35)
        # Set the number of barrels
    ...
    def test_run_build_full_report(self):
        ...
        hy8_file = os.path.join(TestSpecificHy8Runner.hy8_dir, 'Specific_example_build_full_report.hy8')
        hy8_runner = Hy8Runner(TestSpecificHy8Runner.hy8_exe_dir, hy8_file)
    ...
    def test_run_open_save(self):
        """Validate the data for all culvert crossings."""
        # Setup the hy8 filename
        hy8_file = os.path.join(TestSpecificHy8Runner.hy8_dir, 'Specific_example_open_run_save.hy8')
        hy8_runner = Hy8Runner(TestSpecificHy8Runner.hy8_exe_dir, hy8_file)
    ...
    def test_run_open_save_plots(self):
        """Validate the data for all culvert crossings."""
        # Setup the hy8 filename
        hy8_file = os.path.join(TestSpecificHy8Runner.hy8_dir, 'Specific_example_open_run_save_plots.hy8')
        hy8_runner = Hy8Runner(TestSpecificHy8Runner.hy8_exe_dir, hy8_file)
    ...
    def test_run_build_flow_tw_table(self):
        """Validate the data for all culvert crossings."""
        # Setup the hy8 filename
        hy8_file = os.path.join(TestSpecificHy8Runner.hy8_dir, 'Specific_example_build_flow_tw_table.hy8')
        hy8_runner = Hy8Runner(TestSpecificHy8Runner.hy8_exe_dir, hy8_file)
    ...
    def test_run_build_hw_tw_table(self):
        """Validate the data for all culvert crossings."""
        # Setup the hy8 filename
        hy8_file = os.path.join(TestSpecificHy8Runner.hy8_dir, 'Specific_example_build_hw_tw_table.hy8')
        hy8_runner = Hy8Runner(TestSpecificHy8Runner.hy8_exe_dir, hy8_file)
