...
class Hy8RunnerFlow():
    ...
    def __init__(self):
        ...
        self.method = 'min-design-max'  # 'min-design-max', 'user-defined', or 'min-max-increment'
        self.flow_min = 0.0
        self.flow_design = 0.0
        self.flow_max = 0.0
        self.flow_increment = 0.0
        self.flow_list = []
    ...
    def validate_crossings_data(self, crossing_str):
        """Validate the data.
