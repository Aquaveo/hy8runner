...
class Hy8RunnerCulvertBarrel():
    ...
    def __init__(self, count):
        ...
        self.name = f'Culvert {count+1}'
        self.notes = ''

        self.shape = 'circle'  # or 'box'
        self.material = 'concrete'  # or 'corrugated steel'
        self.span = 0.0
        self.rise = 0.0

        self.inlet_invert_elevation = 0.0
        self.inlet_invert_station = 0.0
        self.outlet_invert_elevation = 0.0
        self.outlet_invert_station = 0.0

        self.number_of_barrels = 1

    def write_culvert_to_file(self, hy8_file):
        ...
        hy8_file.write(f'INVERTDATA {self.inlet_invert_station} {self.inlet_invert_elevation} '
